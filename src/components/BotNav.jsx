...
const BotNav = () => {
    ...
    return (
        <>
            <div className='fixed bottom-[30px] right-[20px] z-20'>
                <div className='extension bg-purple-500 rounded-[50px] h-[250px] w-[64px] px-4 py-5'>
            ...
            <div onClick={() => setToggle(!toggle)} className='fixed bottom-[20px] right-[20px] z-20'>
